            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        ...
                        <a href="{{ route('roles_create') }}" class="float-md-right btn btn-success btn-sm">Add Role</a>
                    </div>
                    <div class="body">
                        <div class="table-responsive table_middel">
                            <table class="table m-b-0">
                                ...
                                <tbody>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="10" style="text-align: center;">Roles not found</td>
                                        </tr>
                                    @endif
                            ...
                            @if(isset($roles) && count($roles)>0)
                                {{ $roles->appends(request()->query())->links('common.pagination') }}
                            @endif
                        </div>
                    </div>
                </div>
