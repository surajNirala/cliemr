            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        ...
                        <button class="float-md-right btn btn-success btn-sm" onclick="showTestprescribes()">Add Test Prescribe</button>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover testprescribes_table dataTable">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="createModalLabel">Add Test Prescribe</h4>
            </div>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="testprescribe_id" id="testprescribe_id">
                </div>
                <div class="form-group">
...
@section('perticular_page_scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            try{
                table = $('.testprescribes_table').DataTable({
                    processing: true,
                    serverSide: true,
        ...
        function showTestprescribes(){
            document.getElementById('title').value = ''; 
            document.getElementById('description').value = ''; 
            document.getElementById('testprescribe_id').value = ''; 
            document.getElementById('formErrors').innerHTML = '';
            $("#createModalLabel").text("Add Test Prescribe")
        ...
        function storeData() {
            ...
            const testprescribe_id = $('#testprescribe_id').val();
            $.ajax({
                url: "{{ url('custom-templates/testprescribes/store') }}",
                method: "POST",
                data: {
                    _token: "{{ csrf_token() }}", // CSRF token for security
                    title: title,
                    description: description,
                    testprescribe_id:testprescribe_id
                },
        ...
        function changeStatus(id, status) {
            ...
            $.ajax({
                url: "{{ url('custom-templates/testprescribes/change-status') }}"+`/${id}`,
                method: 'POST',
                data: {
        ...
        function editRow(id) {
            document.getElementById('title').value = ''; 
            document.getElementById('description').value = ''; 
            document.getElementById('testprescribe_id').value = id; 
            document.getElementById('formErrors').innerHTML = '';
            $("#createModalLabel").text("Edit Test Prescribe")
            $.ajax({
                url: "{{ url('custom-templates/testprescribes/edit') }}"+`/${id}`,
                method: 'GET',
                success: function(response) {
                    if (response.success) {                       
        ...
        function deleteRecord(id){
            ...
            $.ajax({
                url: "{{ url('custom-templates/testprescribes/delete') }}"+`/${id}`,
                method: 'GET',
                success: function(response) {
                if (response.success) {
